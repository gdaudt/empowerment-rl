...
####################################################################
    ...
    def reset(self, seed = None, options = None):
        ...
        if self.seed == 1337:
            ...
            x_pos = round(random.uniform(-0.3, 0), 2)
            y_pos = round(random.uniform(self.eval_y - 0.3, self.eval_y + 0.3), 2)
            ...
            if self.eval_y < -0.5:
                ...
                goaly = self.eval_y + 0.5
            # goaly = round(random.uniform(-1.6, 0.5), 2)
...
####################################################################
    ...
    def _computeEmpowerment(self, state):
        ...
        if final_points is not None:
            ...
            empowerment = np.log(hull.volume * self.EMP_CONSTANT)
            return empowerment        
        return 0.0
