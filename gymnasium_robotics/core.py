...
class GoalEnv(gym.Env):
    ...
    @abstractmethod
    def compute_collision(self, achieved_goal, info):
        """Compute the step collision. Allows to customize the collision states depending on the achieved goal.

        If you wish to determine collision states independent of the goal, you can include necessary values to derive it in 'info'
        and compute it accordingly. Collision states are those that are out of the scope of the Markov Decision Process (MDP) such
        as time constraints in a continuing task.
        ...
        Returns:
            bool: The collision state that corresponds to the provided achieved goal.
